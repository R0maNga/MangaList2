...
class MyMangaAdapter(
    private val mangaList: List<MyManga>

) : RecyclerView.Adapter<MyMangaAdapter.MyMangaViewHolder>() {

    class MyMangaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val status: TextView = itemView.findViewById(R.id.tv_my_manga_list_status)
        private val bundle = Bundle()

        fun bind(item: MyManga) {
            ...
            rating.text = item.rank
            status.text = item.watchStatus
